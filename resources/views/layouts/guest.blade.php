...
<body>
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('tlandingpage/assets/images/product-image/6_1.jpg')}}" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{ asset('tlandingpage/assets/images/product-image/12_1.jpg') }}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{ asset('tlandingpage/assets/images/product-image/3_1.jpg') }}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('tlandingpage/assets/images/product-image/3_2.jpg')}}"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('tlandingpage/assets/images/product-image/3_3.jpg')}}"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('tlandingpage/assets/images/product-image/3_4.jpg')}}"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('tlandingpage/assets/images/product-image/3_5.jpg')}}"
                                        alt="">
                                </div>
                            </div>
    ...
    <div id="ec-popnews-box">
        ...
        <div class="row">
            <div class="col-md-6 disp-no-767">
                <img src="{{asset('tlandingpage/assets/images/banner/newsletter.png')}}" alt="newsletter">
            </div>
            <div class="col-md-6">
            ...
            <div class="ec-nav-panel">
                ...
                <div class="ec-nav-panel-icons">
                    <a href="wishlist.html" class="ec-header-btn"><img
                            src="{{asset('tlandingpage/assets/images/icons/wishlist.svg')}}" class="svg_img header_svg"
                            alt="icon" /><span class="ec-cart-noti">4</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="login.html" class="ec-header-btn"><img src="{{asset('tlandingpage/assets/images/icons/user.svg')}}"
                            class="svg_img header_svg" alt="icon" /></a>
                </div>
    ...
    <div class="recent-purchase">
        <img src="{{asset('tlandingpage/assets/images/product-image/1.jpg')}}" alt="payment image">
        <div class="detail">
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
            <div class="header-icon"><img src="{{asset('tlandingpage/assets/images/icons/cart.svg')}}" class="svg_img header_svg"
                    alt="cart" />
            </div>
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('tlandingpage/assets/images/whatsapp/profile_04.jpg')}}" class="ec-user-img"
                                        alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
    ...
    <div class="ec-tools-sidebar">
        ...
        <a href="#" class="ec-tools-sidebar-toggle in-out">
            <img alt="icon" src="{{asset('tlandingpage/assets/images/common/settings.png')}}">
        </a>
