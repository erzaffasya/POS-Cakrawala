<x-app-layout>
    ...
    <div class="row">
                        ...
                        <form class="row g-3" method="post" action="{{ route('suratjalan.store') }}"
                            ...
                            <div class="col-lg-8">
                                <div class="ec-vendor-upload-detail g-3" id="form-product">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="number" name="alamat_penerima" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-12 pt-4 text-end">
                                    ...
                                    <button type="button" class="btn btn-danger" onclick="removeProduct()">Hapus</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script>
            function addProduct() {
                var a = $('#form-product div.row:last').clone(true).addClass("product").insertAfter('#form-product div.row:last');
            }
